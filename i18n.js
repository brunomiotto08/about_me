(function () {
  ...
  const strings = {
    'pt-BR': {
      ...
      'hero.status': 'Disponível para projetos freelance',
      'hero.role': 'Full-Stack Developer · IoT Monitoring & Business Systems',
      'hero.pitch': 'Entrego sistemas prontos para produção — do diagnóstico ao deploy, com monitoramento em tempo real e suporte contínuo.',
      'hero.summary': '<strong>2+ anos em Delphi/ERP na Windel</strong> · Eng. de Software na UCS · Caxias do Sul, RS',
      'hero.stat1.value': '3',
      'hero.stat1.label': 'sistemas em produção',
      'hero.stat2.value': 'Real-time',
      'hero.stat2.label': 'dashboards & alertas',
      'hero.stat3.value': 'EN · PT · ES',
      'hero.stat3.label': 'comunicação remota',
      'hero.meta.company': 'Empresa',
      'hero.meta.college': 'Faculdade',
      'hero.meta.contact': 'Contato',
      'hero.cta.cases': 'Ver casos de sucesso',
      'hero.cta.skills': 'Ver habilidades',
      'hero.cta.talk': 'Agendar conversa',

      'services.title': 'O que eu entrego',
      'services.sub': 'Não vendo código solto — vendo resultado de negócio com sistema funcionando em produção.',
      'services.s1.title': 'Sistemas Full-Stack',
      'services.s1.desc': 'Dashboards, APIs e banco de dados prontos para uso — do MVP ao sistema escalável com autenticação e deploy.',
      'services.s2.title': 'Monitoramento IoT',
      'services.s2.desc': 'Conecto CLPs e sensores a dashboards ao vivo — alertas automáticos, histórico confiável e rastreabilidade por ciclo.',
      'services.s3.title': 'ERP & Integrações',
      'services.s3.desc': 'Otimização de sistemas legados Delphi/Firebird, correções estruturais e integração com APIs, webhooks e automações.',
      'services.s4.title': 'Manutenção & Suporte',
      'services.s4.desc': 'Retainer mensal com correções, melhorias incrementais, monitoramento de uptime e suporte direto via WhatsApp.',
      ...
      'xp.sub': 'Base profissional que sustenta cada entrega — ERP no dia a dia e engenharia na faculdade.',
      'xp.work': 'Trabalho',
      'xp.grad': 'Graduação',
      'xp.windel.role': 'Desenvolvedor Delphi',
      'xp.windel.desc': 'Otimização de ERP Delphi/Firebird para micro e pequenas empresas — correções estruturais que reduzem bugs recorrentes e melhoram performance em produção.',
      ...
      'portfolio.sub': 'Problema real → solução entregue → impacto mensurável.',
      'portfolio.habilita.badge': 'Case · IoT Industrial',
      'portfolio.habilita.before': 'Dados espalhados em CLPs, sem visibilidade central, histórico confiável ou alertas em tempo real no chão de fábrica.',
      'portfolio.habilita.solution': 'Plataforma multi-tenant com ingestão MQTT, dashboards ao vivo via WebSocket e rastreabilidade de pneus por ciclo de autoclave.',
      'portfolio.habilita.result': 'Diagnóstico de falhas em minutos (antes: horas), alertas automáticos com cooldown e histórico completo por máquina.',
      'portfolio.habilita.m1': 'menos tempo de diagnóstico',
      'portfolio.habilita.m2': 'monitoramento ao vivo',
      'portfolio.habilita.m3': 'rastreio por ciclo',
      ...
      'portfolio.fleet.badge': 'Case · SaaS PWA',
      'portfolio.fleet.before': 'Donos de transportadoras sem visão diária de lucro, custos e gargalos — tudo em planilhas desatualizadas.',
      'portfolio.fleet.solution': 'PWA mobile-first que unifica frota, operação e finanças com agenda automática, DRE e KPIs em tempo real.',
      'portfolio.fleet.m1': 'substitui planilhas',
      'portfolio.fleet.m2': 'exportável CSV/PDF',
      ...
      'portfolio.website.badge': 'Case · Marketing',
      'portfolio.website.before': 'Empresa de automação industrial sem presença digital que transmitisse credibilidade técnica para decisores.',
      'portfolio.website.solution': 'Site one-page premium com narrativa de serviços, cases, trajetória e formulário de contato — deploy em produção.',
      'portfolio.website.m1': 'site em produção',
      'portfolio.website.m2': 'carregamento',
      ...
      'portfolio.cta': 'Ver case completo →',

      'pricing.title': 'Investimento',
      'pricing.sub': 'Projetos com escopo fechado ou suporte contínuo — valores em USD para clientes internacionais.',
      'pricing.from': 'a partir de',
      'pricing.popular': 'Popular',
      'pricing.perMonth': '/mês',
      'pricing.t1.tier': 'MVP / Piloto',
      'pricing.t1.desc': 'Validação rápida de ideia — dashboard funcional, autenticação básica e deploy. Ideal para testar o mercado.',
      'pricing.t1.i1': 'Escopo definido em call gratuita',
      'pricing.t1.i2': 'Entrega em 2–4 semanas',
      'pricing.t1.i3': '1 rodada de revisões inclusa',
      'pricing.t2.tier': 'Sistema em Produção',
      'pricing.t2.desc': 'Solução completa — IoT, multi-tenant, alertas, relatórios e documentação. Pronto para operação real.',
      'pricing.t2.i1': 'Arquitetura escalável',
      'pricing.t2.i2': 'Testes e deploy assistido',
      'pricing.t2.i3': '30 dias de suporte pós-entrega',
      'pricing.t3.tier': 'Retainer Mensal',
      'pricing.t3.desc': 'Manutenção, melhorias incrementais e suporte prioritário para sistemas já em produção.',
      'pricing.t3.i1': 'Correções e hotfixes',
      'pricing.t3.i2': 'Melhorias planejadas',
      'pricing.t3.i3': 'Canal direto WhatsApp',
      'pricing.note': 'Valores variam conforme complexidade. Primeira conversa é gratuita — sem compromisso.',
      ...
      'footer.title': 'Pronto para o próximo projeto?',
      'footer.sub': 'Primeira conversa gratuita — conte o problema e receba uma proposta em 48h.',
      ...
      'project.about': 'Sobre',
      'project.about.p1': 'O <strong>Habilita I.M.P.</strong> resolve um problema real do chão de fábrica: dados espalhados em CLPs sem visibilidade central, histórico confiável ou alertas em tempo real. A plataforma recebe telemetria de sensores e CLPs via broker MQTT, processa no backend Node.js, persiste no Supabase e entrega uma interface React moderna para operadores, supervisores e administradores.',
      ...
      'project.fleet.result': 'Visibilidade financeira diária, fechamento automático de linhas e DRE exportável — sem depender de planilhas.',
      ...
      'project.website.result': 'Presença digital profissional ao vivo, com narrativa clara para decisores industriais e formulário de conversão.',
    ...
    'en-US': {
      ...
      'hero.role': 'Full-Stack Developer · IoT Monitoring & Business Systems',
      'hero.pitch': 'I deliver production-ready systems — from diagnosis to deploy, with real-time monitoring and ongoing support.',
      'hero.summary': '<strong>2+ years Delphi/ERP at Windel</strong> · Software Engineering at UCS · Caxias do Sul, Brazil',
      'hero.stat1.value': '3',
      'hero.stat1.label': 'production systems',
      'hero.stat2.value': 'Real-time',
      'hero.stat2.label': 'dashboards & alerts',
      'hero.stat3.value': 'EN · PT · ES',
      'hero.stat3.label': 'remote communication',
      'hero.meta.company': 'Company',
      'hero.meta.college': 'University',
      'hero.meta.contact': 'Contact',
      'hero.cta.cases': 'View success cases',
      'hero.cta.skills': 'View skills',
      'hero.cta.talk': 'Book a call',

      'services.title': 'What I deliver',
      'services.sub': "I don't sell code — I sell business outcomes with systems running in production.",
      'services.s1.title': 'Full-Stack Systems',
      'services.s1.desc': 'Dashboards, APIs, and databases ready to use — from MVP to scalable systems with auth and deploy.',
      'services.s2.title': 'IoT Monitoring',
      'services.s2.desc': 'I connect CLPs and sensors to live dashboards — automatic alerts, reliable history, and cycle traceability.',
      'services.s3.title': 'ERP & Integrations',
      'services.s3.desc': 'Legacy Delphi/Firebird optimization, structural fixes, and integration with APIs, webhooks, and automations.',
      'services.s4.title': 'Maintenance & Support',
      'services.s4.desc': 'Monthly retainer with fixes, incremental improvements, uptime monitoring, and direct WhatsApp support.',
      ...
      'xp.sub': 'Professional foundation behind every delivery — ERP day-to-day and engineering at university.',
      'xp.work': 'Work',
      'xp.grad': 'Degree',
      'xp.windel.role': 'Delphi Developer',
      'xp.windel.desc': 'Delphi/Firebird ERP optimization for micro and small businesses — structural fixes that reduce recurring bugs and improve production performance.',
      ...
      'portfolio.title': 'Success Cases',
      'portfolio.sub': 'Real problem → delivered solution → measurable impact.',
      'portfolio.habilita.badge': 'Case · Industrial IoT',
      'portfolio.habilita.before': 'Data scattered across CLPs with no central visibility, reliable history, or real-time alerts on the shop floor.',
      'portfolio.habilita.solution': 'Multi-tenant platform with MQTT ingestion, live dashboards via WebSocket, and tire traceability per autoclave cycle.',
      'portfolio.habilita.result': 'Fault diagnosis in minutes (before: hours), automatic alerts with cooldown, and full history per machine.',
      'portfolio.habilita.m1': 'faster diagnosis',
      'portfolio.habilita.m2': 'live monitoring',
      'portfolio.habilita.m3': 'cycle traceability',
      ...
      'portfolio.fleet.badge': 'Case · SaaS PWA',
      'portfolio.fleet.before': 'Transport company owners with no daily view of profit, costs, and bottlenecks — everything in outdated spreadsheets.',
      'portfolio.fleet.solution': 'Mobile-first PWA unifying fleet, operations, and finances with automated schedule, income statement, and real-time KPIs.',
      'portfolio.fleet.m1': 'replaces spreadsheets',
      'portfolio.fleet.m2': 'CSV/PDF export',
      ...
      'portfolio.website.badge': 'Case · Marketing',
      'portfolio.website.before': 'Industrial automation company with no digital presence conveying technical credibility to decision-makers.',
      'portfolio.website.solution': 'Premium one-page site with services narrative, cases, company history, and contact form — deployed to production.',
      'portfolio.website.m1': 'live in production',
      'portfolio.website.m2': 'load time',
      ...
      'portfolio.cta': 'View full case →',

      'pricing.title': 'Investment',
      'pricing.sub': 'Fixed-scope projects or ongoing support — USD pricing for international clients.',
      'pricing.from': 'from',
      'pricing.popular': 'Popular',
      'pricing.perMonth': '/mo',
      'pricing.t1.tier': 'MVP / Pilot',
      'pricing.t1.desc': 'Fast idea validation — functional dashboard, basic auth, and deploy. Ideal for market testing.',
      'pricing.t1.i1': 'Scope defined in free call',
      'pricing.t1.i2': 'Delivery in 2–4 weeks',
      'pricing.t1.i3': '1 revision round included',
      'pricing.t2.tier': 'Production System',
      'pricing.t2.desc': 'Complete solution — IoT, multi-tenant, alerts, reports, and documentation. Ready for real operations.',
      'pricing.t2.i1': 'Scalable architecture',
      'pricing.t2.i2': 'Assisted testing and deploy',
      'pricing.t2.i3': '30 days post-delivery support',
      'pricing.t3.tier': 'Monthly Retainer',
      'pricing.t3.desc': 'Maintenance, incremental improvements, and priority support for systems already in production.',
      'pricing.t3.i1': 'Fixes and hotfixes',
      'pricing.t3.i2': 'Planned improvements',
      'pricing.t3.i3': 'Direct WhatsApp channel',
      'pricing.note': 'Pricing varies by complexity. First call is free — no commitment.',
      ...
      'footer.title': 'Ready for your next project?',
      'footer.sub': 'First call is free — tell me the problem and get a proposal within 48 hours.',
      'footer.copy': '© 2026 Bruno Miotto — Caxias do Sul, RS',
      ...
      'project.about': 'About',
      'project.about.p1': '<strong>Habilita I.M.P.</strong> solves a real shop-floor problem: data scattered across CLPs with no central visibility, reliable history, or real-time alerts. The platform receives telemetry from sensors and CLPs via an MQTT broker, processes it on a Node.js backend, persists to Supabase, and delivers a modern React interface for operators, supervisors, and administrators.',
      ...
      'project.fleet.result': 'Daily financial visibility, automatic line closing, and exportable income statement — no spreadsheets needed.',
      ...
      'project.website.result': 'Professional live digital presence with a clear narrative for industrial decision-makers and a conversion contact form.',
      ...
      'project.website.f01.desc': 'Slides alternating electrical panels, CLPs, and exploded view of control cabinets — with engineering badge, highlighted headline, and conversion buttons.',
      ...
      'project.website.gallery.c3': 'Hero — Mitsubishi programmable CLP',
    ...
    'es': {
      ...
      'hero.role': 'Full-Stack Developer · IoT Monitoring & Business Systems',
      'hero.pitch': 'Entrego sistemas listos para producción — del diagnóstico al deploy, con monitoreo en tiempo real y soporte continuo.',
      'hero.summary': '<strong>2+ años en Delphi/ERP en Windel</strong> · Ing. de Software en UCS · Caxias do Sul, RS',
      'hero.stat1.value': '3',
      'hero.stat1.label': 'sistemas en producción',
      'hero.stat2.value': 'Real-time',
      'hero.stat2.label': 'dashboards y alertas',
      'hero.stat3.value': 'EN · PT · ES',
      'hero.stat3.label': 'comunicación remota',
      'hero.meta.company': 'Empresa',
      'hero.meta.college': 'Universidad',
      'hero.meta.contact': 'Contacto',
      'hero.cta.cases': 'Ver casos de éxito',
      'hero.cta.skills': 'Ver habilidades',
      'hero.cta.talk': 'Agendar conversación',

      'services.title': 'Lo que entrego',
      'services.sub': 'No vendo código suelto — vendo resultados de negocio con sistemas funcionando en producción.',
      'services.s1.title': 'Sistemas Full-Stack',
      'services.s1.desc': 'Dashboards, APIs y bases de datos listos para usar — del MVP al sistema escalable con autenticación y deploy.',
      'services.s2.title': 'Monitoreo IoT',
      'services.s2.desc': 'Conecto CLPs y sensores a dashboards en vivo — alertas automáticas, historial confiable y trazabilidad por ciclo.',
      'services.s3.title': 'ERP e Integraciones',
      'services.s3.desc': 'Optimización de sistemas legados Delphi/Firebird, correcciones estructurales e integración con APIs, webhooks y automatizaciones.',
      'services.s4.title': 'Mantenimiento y Soporte',
      'services.s4.desc': 'Retainer mensual con correcciones, mejoras incrementales, monitoreo de uptime y soporte directo vía WhatsApp.',
      ...
      'xp.sub': 'Base profesional que sustenta cada entrega — ERP en el día a día e ingeniería en la universidad.',
      'xp.work': 'Trabajo',
      'xp.grad': 'Grado',
      'xp.windel.role': 'Desarrollador Delphi',
      'xp.windel.desc': 'Optimización de ERP Delphi/Firebird para micro y pequeñas empresas — correcciones estructurales que reducen bugs recurrentes y mejoran el rendimiento en producción.',
      ...
      'portfolio.sub': 'Problema real → solución entregada → impacto medible.',
      'portfolio.habilita.badge': 'Case · IoT Industrial',
      'portfolio.habilita.before': 'Datos dispersos en CLPs, sin visibilidad central, historial confiable o alertas en tiempo real en planta.',
      'portfolio.habilita.solution': 'Plataforma multi-tenant con ingesta MQTT, dashboards en vivo vía WebSocket y trazabilidad de neumáticos por ciclo de autoclave.',
      'portfolio.habilita.result': 'Diagnóstico de fallas en minutos (antes: horas), alertas automáticas con cooldown e historial completo por máquina.',
      'portfolio.habilita.m1': 'menos tiempo de diagnóstico',
      'portfolio.habilita.m2': 'monitoreo en vivo',
      'portfolio.habilita.m3': 'trazabilidad por ciclo',
      ...
      'portfolio.fleet.badge': 'Case · SaaS PWA',
      'portfolio.fleet.before': 'Dueños de transportadoras sin visión diaria de ganancias, costos y cuellos de botella — todo en hojas de cálculo desactualizadas.',
      'portfolio.fleet.solution': 'PWA mobile-first que unifica flota, operación y finanzas con agenda automática, estado de resultados y KPIs en tiempo real.',
      'portfolio.fleet.m1': 'reemplaza hojas de cálculo',
      'portfolio.fleet.m2': 'exportable CSV/PDF',
      ...
      'portfolio.website.badge': 'Case · Marketing',
      'portfolio.website.before': 'Empresa de automatización industrial sin presencia digital que transmitiera credibilidad técnica a decisores.',
      'portfolio.website.solution': 'Sitio one-page premium con narrativa de servicios, casos, trayectoria y formulario de contacto — deploy en producción.',
      'portfolio.website.m1': 'sitio en producción',
      'portfolio.website.m2': 'tiempo de carga',
      ...
      'portfolio.cta': 'Ver caso completo →',

      'pricing.title': 'Inversión',
      'pricing.sub': 'Proyectos de alcance fijo o soporte continuo — precios en USD para clientes internacionales.',
      'pricing.from': 'desde',
      'pricing.popular': 'Popular',
      'pricing.perMonth': '/mes',
      'pricing.t1.tier': 'MVP / Piloto',
      'pricing.t1.desc': 'Validación rápida de idea — dashboard funcional, autenticación básica y deploy. Ideal para probar el mercado.',
      'pricing.t1.i1': 'Alcance definido en llamada gratuita',
      'pricing.t1.i2': 'Entrega en 2–4 semanas',
      'pricing.t1.i3': '1 ronda de revisiones incluida',
      'pricing.t2.tier': 'Sistema en Producción',
      'pricing.t2.desc': 'Solución completa — IoT, multi-tenant, alertas, reportes y documentación. Listo para operación real.',
      'pricing.t2.i1': 'Arquitectura escalable',
      'pricing.t2.i2': 'Pruebas y deploy asistido',
      'pricing.t2.i3': '30 días de soporte post-entrega',
      'pricing.t3.tier': 'Retainer Mensual',
      'pricing.t3.desc': 'Mantenimiento, mejoras incrementales y soporte prioritario para sistemas ya en producción.',
      'pricing.t3.i1': 'Correcciones y hotfixes',
      'pricing.t3.i2': 'Mejoras planificadas',
      'pricing.t3.i3': 'Canal directo WhatsApp',
      'pricing.note': 'Los valores varían según complejidad. Primera conversación gratuita — sin compromiso.',
      ...
      'footer.title': '¿Listo para el próximo proyecto?',
      'footer.sub': 'Primera conversación gratuita — cuéntame el problema y recibe una propuesta en 48h.',
      'footer.copy': '© 2026 Bruno Miotto — Caxias do Sul, RS',
      ...
      'project.about': 'Sobre',
      'project.about.p1': '<strong>Habilita I.M.P.</strong> resuelve un problema real de planta: datos dispersos en CLPs sin visibilidad central, historial confiable o alertas en tiempo real. La plataforma recibe telemetría de sensores y CLPs vía broker MQTT, procesa en el backend Node.js, persiste en Supabase y entrega una interfaz React moderna para operadores, supervisores y administradores.',
      ...
      'project.fleet.result': 'Visibilidad financiera diaria, cierre automático de líneas y estado de resultados exportable — sin depender de hojas de cálculo.',
      ...
      'project.website.result': 'Presencia digital profesional en vivo, con narrativa clara para decisores industriales y formulario de conversión.',
